        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb float-sm-right">
                  <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><a href="{{route('product.create')}}" style="color: #f6f1f1">+ Add New</a></button>
                </ol>
              </div><!-- /.col -->
        </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" style="color:black">All Product List</h3>
            </div>
        </div><br>
        <div class="row p-2">
