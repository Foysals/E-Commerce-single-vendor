...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('back.product.index',compact('category','brand','warehouses'));
    }
      //product create page
      public function create()
      {
        ...
        //  $childcategory=DB::table('childcategory_id')->get();  // Warehouse::all();
  
          return view('back.product.create',compact('category','brand','pickup_point','warehosue'));
      }
      ...
      public function store(Request $request)
      {
         ...
         if($request->hasFile('images')){
             foreach ($request->file('images') as $key => $image) {
    	      ...
    	      $image->move('files/product/',$imageName);  //without image intervention
      ...
      public function edit($id)
      {
          ...
          return view('back.product.edit',compact('product','category','brand','warehouse','pickup_point','childcategory'));
      }
