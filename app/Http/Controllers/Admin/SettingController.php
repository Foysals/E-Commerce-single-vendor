...
class SettingController extends Controller
{
    public function __construct()
    {
     ...
     public function seo()
     {
         ...
         return view('back.setting.seo',compact('data'));
     }
      //update seo method
    ...
    public function website()
    {
        ...
        return view('back.setting.website_setting',compact('setting'));
    }
    ...
    public function PaymentGateway()
    {
        ...
        return view('back.bdpayment_gateway.edit',compact('aamarpay','surjopay','ssl'));
    }
