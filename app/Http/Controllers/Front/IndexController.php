...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.page.index',compact('category','bannerproduct','featured','popular_product','trendy_product','home_category','brand','random_product','todaydeal','review','campaign'));
    }
    ...
    public function ProductDetails($slug)
    {
        ...
        return view('front.page.product.product_details',compact('product','related_product','review'));
    }
    ...
    public function ProductQuickView($id)
    {
        ...
        return view('front.page.product.quick_view',compact('product'));
    }
    ...
    public function categoryWiseProduct($id)
    {
        ...
        $random_product=Product::where('status',1)->inRandomOrder()->limit(16)->get();
        return view('front.page.product.category_products',compact('subcategory','brand','products','random_product','category'));
    ...
    public function SubcategoryWiseProduct($id)
    {
        ...
        $random_product=Product::where('status',1)->inRandomOrder()->limit(16)->get();
        return view('front.page.product.subcategory_product',compact('childcategories','brand','products','random_product','subcategory'));
    }
    ...
    public function ChildcategoryWiseProduct($id)
    {
        ...
        $random_product=Product::where('status',1)->inRandomOrder()->limit(16)->get();
        return view('front.page.product.childcategory_product',compact('categories','brand','products','random_product','childcategory'));
    }
    ...
    public function BrandWiseProduct($id)
    {
        ...
        $random_product=Product::where('status',1)->inRandomOrder()->limit(16)->get();
        return view('front.page.product.brandwise_product',compact('categories','brands','products','random_product','brand'));
    }
    ...
    {
        return view('front.page.order_tracking');
    }
    ...
    public function CheckOrder(Request $request)
    {
        ...
        if ($check) {
            ...
            return view('front.page.order_details',compact('order','order_details'));
        }else{
    ...
    public function CampaignProduct($id)
    {
        $products=DB::table('campaign_product')->leftJoin('products','campaign_product.product_id','products.id')
                    ...
                    ->paginate(32);          
        return view('front.page.campaign.product_list',compact('products'));
    }
    ...
    public function CampaignProductDetails($slug)
    {
        ...
        $review=Review::where('product_id',$product->id)->orderBy('id','DESC')->take(6)->get();
        return view('front.page.campaign.product_details',compact('product','related_product','review','product_price'));
